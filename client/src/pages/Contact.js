      ...
      <div className="container pt-20 mx-auto md:px-6">
        ...
        <section className="mb-32">
          ...
          <div className="container px-6 md:px-12">
            <div className="block rounded-lg text-white px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] bg-[hsla(0,0%,5%,0.7)] shadow-black/20 md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
